...
<a href="https://and-revision.netlify.app/"><button class="button">« Back to Home</button></a> <a href="https://and-revision.netlify.app/opt1/bbw1"><button class="button right">Next Section »</button></a>
