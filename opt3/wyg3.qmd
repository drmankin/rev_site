...
1. What is the equation of the line for this model?

1. What productivity score does the model predict for someone that consumes 8 cups of coffee a day? Make sure you use *b*s rounded to 2 decimal places, and round your answer as well.
...
<label for="answer1">Transmission Frequency:</label>
<input type="text" id="answer1" style="color: grey;"> Hz
<br>
<label for="answer2">Code to Send:</label>
<input type="text" id="answer2" style="color: grey;">
<br>
<button onclick="checkAnswers()" style="color: grey;">Send Transmission!</button>