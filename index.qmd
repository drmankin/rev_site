...
- Option 3, the "gamified" condition[^1].

[^1]: If you're wondering about option 2 - there was one originally, but we decided to drop it based on the number of people participating, so no one saw option 2.
